...
label_file_t1=$PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T1w_labels-disc-manual.nii.gz
label_file_t2=$PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T2w_labels-disc-manual.nii.gz

sct_label_vertebrae -i ${file_t2w}.nii.gz -s ${file_seg_t2} -c t2 -discfile ${label_file_t2} -ofolder $PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/
...
mv $PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T2w_seg_labeled_discs.nii.gz $PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T2w_projected-gt.nii.gz


mv $PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T1w_seg_labeled_discs.nii.gz $PATH_RESULTS/data/derivatives/labels/$SUBJECT/anat/${SUBJECT}_T1w_projected-gt.nii.gz
